...
function App() {
  ...
  return (
    <div style={{ margin: '2rem', padding: '1rem', outline: '0.5rem solid black', height: isPageLong ? '110vh' : '20vh' }}>
      ...
      >
        ...
        <div style={{ margin: '2rem', padding: '1rem', backgroundColor: 'white', position: 'relative', zIndex: 10 }} className="p-8 my-16 bg-white rounded shadow relative z-10 overflow-auto">
